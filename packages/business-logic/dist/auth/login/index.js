...
var login = function (_a) {
    ...
    return __awaiter(void 0, void 0, void 0, function () {
        var result, user, isValidPassword, token;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0: return [4 /*yield*/, (0, postgresql_1.getDbInstance)().select().from(entities_1.users)
                ...
                case 1:
                    ...
                    if (user.locked)
                        throw new Error("Admin is already locked");
