      ...
      <div className={styles.container}>
        ...
        <div className={styles.social}>
          ...
          <div className={styles.networks}>
            <Link href="https://instagram.com/itaaj.mx?igshid=YmMyMTA2M2Y=" rel="noopener noreferrer" passHref>
                <i className="bx bxl-instagram"></i>
            </Link>
            <Link href="https://www.facebook.com/itaajrealty" rel="noopener noreferrer" passHref>
            ...
            <Link href="https://www.linkedin.com/company/itaajonchain/" rel="noopener noreferrer" passHref>
