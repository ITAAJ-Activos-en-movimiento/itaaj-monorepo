...
const Property = ({ params }: { params: { slug: string } }) => {
  ...
  const whatsappLink =
    typeof window !== "undefined"
      ? `https://api.whatsapp.com/send?phone=+5219995471508&text=Te hablo de la pagina Itaaj.com por la siguiente propiedad ${window.location.href}`
      : "https://api.whatsapp.com/send?phone=+5219995471508&text=Te hablo de la pagina Itaaj.com por la siguiente propiedad";
        ...
        <>
          <div className={styles.banner}>
            <div className={styles.info_banner}>
              <h2>{property?.name}</h2>
              <p>
                {changeLanguage(property?.type)} de {property?.area?.total_area}{" "}
                m&sup2;
              </p>
            </div>
            <Image
          ...
          <div className={styles.header}>
            <div className={styles.title}>
              <h2>
                CONOCE TU PROXIMO {property?.type?.toString().toUpperCase()} EN{" "}
                {property?.city?.toString().toUpperCase()}
              </h2>
              <p
            ...
            <div className={styles.info}>
              ...
              <div className={styles.buttons_list}>
                ...
                <button onClick={handleShare} className={styles.btn_share}>
          ...
          <div className={styles.specs}>
            ...
            <div className={styles.caract}>
              ...
              <ul>
                <li>
                  {changeLanguage(property?.type)} de{" "}
                  {property?.area?.total_area} m&sup2;
                </li>
