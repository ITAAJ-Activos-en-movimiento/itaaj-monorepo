      ...
      <div className={styles.info}>
        <Link title="" href={`/developments/${property.slug}`}>
          ...
          <ul className={styles.features}>
            ...
            <li>
              <i className="bx bx-building"></i> {property.households}{" "}
              Departamentos
            </li>
            <li>
          ...
          <div>
            <h4 className={styles.other_title}>
              OTROS INMUEBLES DEL DESARROLLO
            </h4>
            <ul className={styles.properties_list}>
              {property.properties.slice(0, 3).map((prop) => (
                <li key={prop.id}>
                  <Link href={`/developments/${property.slug}`}>
                    <span className={styles.prop_price}>
                      {DivisaFormater({ value: prop.price })}
                    </span>
            ...
            <Link
              ...
              href={`/developments/${property.slug}`}
            >
              Mostrar más inmuebles de la promoción <ChevronRight />
            </Link>
          </div>
        </Link>
        ...
        <div className={styles.contact}>
          <div>
            ...
            <Link
              href="https://api.whatsapp.com/send?phone=+5219995471508&text=Te hablo de la pagina https://itaajrealty.com"
              target="_blank"
            >
