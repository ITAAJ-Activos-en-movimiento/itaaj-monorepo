    ...
    try {
      await axios.post(
        "https://itaaj-realty.onrender.com/api/v1/properties",
        {
          ...
          images: urls,
          type,
          location: { latitude: longitud, longitude: latitud },
        },
        {
          headers: {
            "api-key":
  ...
  const onSubmitRegister = async () => {
    try {
      const { data } = await axios.post(
        "https://itaajrealty.com/api/v1/auth/register",
        user,
        {
          headers: {
            "api-key":
  ...
  return (
    <GoogleOAuthProvider clientId="203221248558-a6j3egm9pakf8d8c3m2be7vm18k802db.apps.googleusercontent.com">
      <div className={styles.container}>
        ...
        <div>
          ...
          <div className={styles.type}>
            ...
            <div
              ...
              className={type == "department" ? styles.active : ""}
            >
              <span>
                <svg viewBox="0 0 24 24">
                  <path d="M21.75 12a.75.75 0 0 1 .743.648l.007.102v9a2.25 2.25 0 0 1-2.096 2.245L20.25 24H3.75a2.25 2.25 0 0 1-2.245-2.096L1.5 21.75v-9a.75.75 0 0 1 1.493-.102L3 12.75v9c0 .38.282.693.648.743l.102.007h16.5a.75.75 0 0 0 .743-.648L21 21.75v-9a.75.75 0 0 1 .75-.75zm-.603-12H2.852c-.703 0-1.311.487-1.465 1.173L.017 7.337 0 7.5a3 3 0 0 0 3 3l.176-.005a2.99 2.99 0 0 0 1.926-.854l.148-.158.016.019A2.99 2.99 0 0 0 7.5 10.5l.176-.005a2.993 2.993 0 0 0 2.058-.993l.015-.019.017.019A2.99 2.99 0 0 0 12 10.5l.176-.005a2.993 2.993 0 0 0 2.058-.993l.015-.019.017.019a2.99 2.99 0 0 0 2.234.998l.176-.005a2.99 2.99 0 0 0 1.926-.854l.148-.158.016.019A3 3 0 0 0 24 7.5l-.018-.163-1.37-6.163A1.499 1.499 0 0 0 21.147 0zM1.507 7.644l-.004-.076L2.852 1.5h18.296l1.349 6.07.003-.07a1.5 1.5 0 0 1-3 0c0-.958-1.378-.998-1.492-.12L18 7.5a1.5 1.5 0 0 1-3 0c0-.958-1.378-.998-1.492-.12l-.008.12a1.5 1.5 0 0 1-3 0c0-.958-1.378-.998-1.492-.12L9 7.5a1.5 1.5 0 0 1-3 0c0-.958-1.378-.998-1.492-.12L4.5 7.5a1.5 1.5 0 0 1-2.993.144z"></path>
                  <path d="M15 16.5a.75.75 0 0 1 .102 1.493L15 18H2.25a.75.75 0 0 1-.102-1.493l.102-.007H15z"></path>
                  <path d="M15 12a.75.75 0 0 1 .743.648l.007.102v10.5a.75.75 0 0 1-1.493.102l-.007-.102v-10.5A.75.75 0 0 1 15 12z"></path>
                </svg>
              </span>
              <h4>Departamento</h4>
            </div>
            ...
            <div
              ...
              className={type == "other" ? styles.active : ""}
            >
              <span>
                <svg viewBox="0 0 24 24">
                  <path d="M.75 13.488a.75.75 0 0 1 .743.648l.007.102v9a.75.75 0 0 1-1.493.102L0 23.238v-9a.75.75 0 0 1 .75-.75zm22.5 0h-9a.75.75 0 0 0-.75.75v8.5c0 .69.56 1.25 1.25 1.25h8c.69 0 1.25-.56 1.25-1.25v-8.5a.75.75 0 0 0-.75-.75zm-.75 1.5v7.5H15v-7.5h7.5z"></path>
                  <path d="M22.75 10.488H1.25c-.69 0-1.25.56-1.25 1.25v2.5c0 .414.336.75.75.75h22.5a.75.75 0 0 0 .75-.75v-2.5c0-.69-.56-1.25-1.25-1.25zm-.25 1.5v1.5h-21v-1.5h21zm.75 6a.75.75 0 0 1 .102 1.493l-.102.007h-9a.75.75 0 0 1-.102-1.493l.102-.007h9zm-9-18h-9A2.25 2.25 0 0 0 3 2.238v4.5a2.25 2.25 0 0 0 2.25 2.25h9a2.25 2.25 0 0 0 2.25-2.25v-4.5a2.25 2.25 0 0 0-2.25-2.25zm-9 1.5h9a.75.75 0 0 1 .75.75v4.5a.75.75 0 0 1-.75.75h-9a.75.75 0 0 1-.75-.75v-4.5a.75.75 0 0 1 .75-.75z"></path>
                  <path d="M9.75 7.488a.75.75 0 0 1 .743.648l.007.102v3a.75.75 0 0 1-1.493.102L9 11.238v-3a.75.75 0 0 1 .75-.75z"></path>
                </svg>
              </span>
              <h4>Otro</h4>
            </div>
        ...
        <div>
          <span className={styles.type_sell}>
            Esta propiedad sera publicada para venta
          </span>
        </div>
        <div>
          ...
          <div>
            ...
            <div className={styles.field}>
              ...
              <span className={styles.tip}>
                {" "}
                Precio sin coma ni puntos. ¿Dudas con el precio?{" "}
                <Link href={whatsappLinkHelp} target="_blank">
                  Contactanos
                </Link>
              </span>
            </div>
        ...
        <div className={styles.field}>
          ...
          <textarea
            ...
            name="description"
            id=""
            placeholder="La gente valora informacion que no aparece en las fotos, como luminosidad o altura de la vivienda. Asi como informacion relevante de la zona"
          ></textarea>
        </div>
      ...
      <div className={styles.footer}>
        <button className={styles.opacity}>Publicar</button>
      </div>
    </GoogleOAuthProvider>
  );
};
