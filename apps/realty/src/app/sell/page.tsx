    ...
    <>
      ...
      <section className={styles.section}>
        <div className={styles.left}>
          ...
          <p>
            Si por algún motivo te urge vender tu propiedad, recibe una
            propuesta comercial para comprar tu inmueble en plazo no mayor a 7
            días.
          </p>

          <p>
            Prueba nuestro servicio, configúralo a tu medida y gestiona de forma
            sencilla y eficiente tus inmuebles.
            <br /> ¿Te interesa captar público extranjero? Con Itaaj tendrás
            difusión de tus inmuebles nacional e internacionalmente.
          </p>
          <div className={styles.image}>
            <Image
              src="/proposal.jpg"
        ...
        <div className={styles.right}>
          ...
          <p>
            Obtén una propuesta de compra personalizada para tu propiedad
            completando nuestro formulario. Uno de nuestros expertos se pondrá
            en contacto contigo para explicarte la oferta en detalle y responder
            a cualquier pregunta que tengas. ¡Solicita tu propuesta hoy mismo!
          </p>
        </div>
      </section>
