...
export const metadata: Metadata = {
  ...
  description: 'Más de 1.500.000 departamentos en venta, casas y oficinas nuevos o de segunda mano. Vende o compra tu departamento o casa en Itaaj Realty completamente GRATIS!',
}
    ...
    <div>
        ...
        <div className={styles.banner} >
            <div>
                ...
                <p>Para ayudarte, en cada paso, a elegir bien y tomar la mejor decisión</p>
            </div>
        ...
        <section className={styles.section} >
            ...
            <p className={styles.copy}>Explora las posibilidades para vender tu inmueble rápido y al mejor precio</p>
            ...
            <Image src="/price.png" width={550} height={450} alt='Precio' />
                ...
                <div className={styles.info}>
                    ...
                    <p>Calcula el precio en base a sus características y a otros pisos de la zona. Acompañarte es darte todas las herramientas sin coste.</p>
            ...
            <article className={styles.article}>
                ...
                <div className={styles.info}>
                    ...
                    <p>Te ayudamos a encontrar agencias expertas en tu zona dispuestas a ahorrarte tiempo y esfuerzos. Benefíciate de su experiencia y conocimiento del mercado.</p>
            ...
            <Image src="/ad.png" width={550} height={450} alt='Precio' />
                ...
                <div className={styles.info}>
                    ...
                    <p>Aprovecha la amplia visibilidad y el acceso a una gran audiencia de posibles compradores.</p>
      ...
      <section className={styles.section}>
        ...
        <details>
          ...
          <p>
          Desde Itaaj Realty únicamente queremos ayudarte a encontrar las características de tu propiedad y facilitarte el proceso de venta o alquiler a través de expertos en el sector.
          </p>
        </details>
        <details>
...
En resumen, vender una vivienda a través de una agencia implica aprovechar los conocimientos y la experiencia de los agentes inmobiliarios para facilitar el proceso de venta desde la evaluación inicial hasta el cierre de la transacción.
        ...
        <details>
          <summary>
            Qué puedo hacer para vender mi casa rápido?
          </summary>
          <p>
...
En esta página de Itaaj podrás encontrar las agencias expertas en tu zona dispuestas a ayudarte con la venta de tu vivienda.
