...
export default async function AdBoostPageContainer({ params }: PageProps) {
  ...
  const listing = (await res.json()) as Property;
      ...
      <section className={styles.leftColumn}>
        <div className={styles.adCard}>
          ...
          <div className={styles.adInfo}>
            ...
            <p className={styles.adMeta}>{listing?.area?.total_area} m²</p>
        ...
        <div className={styles.adCreateCard}>
          ...
          <Link href="/publish" type="button" className={styles.outlineButton}>
            Publicar otro anuncio
          </Link>
        </div>
      </section>

      {/* Columna central: productos de visibilidad */}
