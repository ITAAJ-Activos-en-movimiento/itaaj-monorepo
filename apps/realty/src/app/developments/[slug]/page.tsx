      ...
      <div className={styles.info}>
        <div className={styles.picture}>
          ...
          <div className={styles.image_info}>
            <Link href="?photos=true" className={styles.photos}>
              <Camera size={14} /> {development?.images?.length} Fotos
            </Link>
            {development.owner && (
              <Link href={development.owner} className={styles.tres}>
                <Info size={14} /> Brochure
              </Link>
            )}
            {development.virtualTourUrl && (
              <Link href={development.virtualTourUrl} className={styles.lett}>
                <Globe size={14} />
                360
              </Link>
            )}
            {development.video && (
              <Link href={development.video} className={styles.lettre}>
                <ImageIcon size={14} />
                Video
              </Link>
            )}
        ...
        <div className={styles.details}>
          ...
          <h3>
            Preventa desde {DivisaFormater({ value: development?.price })}
          </h3>
          <ul>
            <li>
      ...
      <div className={styles.container}>
        <div>
          <div className={styles.main}>
            <Link href="?proposal=open" className={styles.btn}>
