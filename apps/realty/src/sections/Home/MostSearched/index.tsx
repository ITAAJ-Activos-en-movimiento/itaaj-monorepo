...
import styles from './MostSearched.module.css'
...
const MostSearched = () => {
  return (
    <section className={styles.section} >
        ...
        <ul>
            <li><Link href='/properties'>Propiedades de bancos</Link></li>
            <li><Link href='/properties'>Casas en venta</Link></li>
            <li><Link href='/properties'>Departamentos en venta</Link></li>
            <li><Link href='/properties'>Terrenos en venta</Link></li>
            <li><Link href='/properties'>Departamentos y casas baratas</Link></li>
            <li><Link href='/properties'>Chalets en venta</Link></li>
            <li><Link href='/properties'>Lofts en venta</Link></li>
            ...
            <li><Link href='/properties'>Oficinas en venta</Link></li>
            <li><Link href='/properties'>Casas con piscina en venta</Link></li>
            <li><Link href='/properties'>Casas de lujo en venta</Link></li>
