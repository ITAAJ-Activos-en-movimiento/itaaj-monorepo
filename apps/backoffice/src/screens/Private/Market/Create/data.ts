export const municipios: { [key: string]: { label: string, value: string }[]} = {
    "aguascalientes": [
    {
...
export const colonias: { [key: string]: { label: string, value: string }[]} = {
    "naucalpan": [
...
"huixquilucan": [
    {
        "label": "Bosques de la Herradura",
        "value": "bosques-de-la-herradura"
    }
]
